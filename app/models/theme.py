...
class Theme(models.Model):
    ...
    button_primary = ColorField(default='#013372', help_text=_("Primary button color."), verbose_name=_("Button Primary"))
    button_default = ColorField(default='#013372', help_text=_("Default button color."), verbose_name=_("Button Default"))
