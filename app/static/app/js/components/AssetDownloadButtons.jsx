...
class AssetDownloadButtons extends React.Component {
    ...
    render(){
        ...
        return (<div className={"asset-download-buttons " + (this.props.showLabel ? "btn-group" : "") + " " + (this.props.direction === "up" ? "dropup" : "")}>
          ...
          <button type="button" className={"btnn btn-sm " + this.props.buttonClass} disabled={this.props.disabled} data-toggle="dropdown">
            <i className="fa fa-download" style={{color:"#F7941E"}}></i><span className="hidden-xs hidden-sm">{this.props.showLabel ? " " + _("Download Assets") : ""}</span>
          </button>
