...
class TaskListItem extends React.Component {
  ...
  render() {
            ...
            <div className="col-md-12 no-padding">
              <table className="table table-condensed info-table">
                <tbody>
                  <tr>
                    <td>
                      <strong>{_("Created on:")}</strong>
                    </td>
                    <td>
                      <strong>{_("Average GSD:")}</strong>
                    </td>
                    <td>
                      <strong>{_("Area:")}</strong>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      {stats &&
                        stats.gsd &&
                        parseFloat(stats.gsd.toFixed(2)).toLocaleString() +
                          " cm"}
                    </td>
                    <td>
                      {stats && stats.area
                        ? parseFloat(stats.area.toFixed(2)).toLocaleString()
                        : "0"}{" "}
                      m&sup2;
                    </td>
                  </tr>
                  {/* <tr>
                    <td>
                      <strong>{_("Processing Node:")}</strong>
                    </td>
                    <td>
                      {task.processing_node_name || "-"} (
                      {task.auto_processing_node ? _("auto") : _("manual")})
                    </td>
                  </tr> */}
                  ...
                  <tr>
                    <td>
                      <strong>{_("Reconstructed Points:")}</strong>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      {stats &&
                        stats.pointcloud &&
                        stats.pointcloud.points &&
                        stats.pointcloud.points.toLocaleString()}
                    </td>
                    <td>
                      {task.size > 0 &&
    ...
    let taskActionsIcon = "fa-ellipsis-v";
    ...
    return (
      <div style={{ width: "49%" }}>
        ...
        ></div>
        <div className="task-list-item" style={{ width: "100%" }}>
          ...
          >
            <div className="col-xs-7 col-sm-6 col-md-5 col-lg-6 name">
              {/* <i
                ...
                className={
                  "clickable far " +
                  (this.state.expanded ? "fa-minus-square" : " fa-plus-square")
                }
              ></i>{" "} */}
              <a
            ...
            <div
              className="col-md-1 hidden-xs hidden-sm details"
              style={{ width: "fit-content" }}
            >
              <i className="far fa-image"></i> {task.images_count}
            </div>
            <div
              className="col-md-2 hidden-xs hidden-sm details"
              style={{ width: "fit-content" }}
            >
